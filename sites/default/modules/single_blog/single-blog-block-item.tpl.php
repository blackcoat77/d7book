...
/**
 * @file  HTML for an item in the single blog's block listing.
 * 
 * Available variables:
 * 
 ...
 *                  -   $date: Formatted creation date. Preprocess functions can reformat it by calling
 *                                 format_date() with the desired parameters on the $created variable.
